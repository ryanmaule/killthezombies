	...
	<table width="600" align="center" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td style="padding: 10px;">
				<h1>Kill The Zombies has launched a new website!</h1>
				
				<p>Hello <?php echo $username;?>,</p>
				
				<p>We're very proud to announce that tonite we have launched the next version of Kill The Zombies!</p>
				
				<p>You can log into the new Kill The Zombies! website with your old username and password.  If you forget your password, please <a href="<?php echo base_url('user/forgot_password?username='.$username) ?>">click here</a> to request a password reset.</p>
				
				<p>The new Kill The Zombies! has got the goods!  We've got over 250 zombie games, from the very best to the very worst.  Come out and kill some!</p>
				
				<p></p>
				
				<p>We're writing you because at one time, you registered an account at <a href="http://www.killthezombies.com">http://www.killthezombies.com</a>.  If you would like to unsubscribe and stop receiving these emails <a href="%%unsubscribe%%">click here</a>.</p>
			</td>
			<td width="10"></td>
		</tr>
		<tr>
